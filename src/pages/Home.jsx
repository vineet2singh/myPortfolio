...
function Home() {
  return (
    <>
      <div className='w-full h- bg-slate-950 z-0  '>
        <div className='w-full bg-slate-900   flex  '>

          <div className='pt-10 pl-10 w-2/3 max-sm:w-full max-sm:pt-5 max-sm:pl-0'>
            <div className=''>
              <h1 className='text-slate-400 text-xl sm:text-2xl font-bold inline-block max-sm:pl-5'>Wellcome to my Portfolio,</h1> <br />
              <h1 className='text-white text-2xl sm:text-3xl font-extrabold tracking-wider ml-8 mt-5 inline-block max-sm:mt-2'>Hey I'm <span className='text-orange-600 max-sm:'>Vineet</span></h1> <br />
