...
import NameTyping from './NameTyping'
      ...
      <div className='w-full h-screen bg-slate-950 '>
        <div className='w-full bg-slate-900   flex'>
          <div className='pt-10 pl-10 w-2/3  '>
            ...
            <h1 className='text-white text-3xl font-extrabold tracking-wider ml-8 mt-5 inline-block'>Hey I'm <span className='text-orange-600'><NameTyping/></span></h1> <br />
            <div className='mt-1 text-violet-500 text-lg font-mono font- ml-8 inline-block '>
              <Developer />
            </div>
            {/* Introduction */}
            ...
            <div className='mt-5 w-full flex justify-end pr-10 border-b-2 pb-3 border-yellow-300 '>
